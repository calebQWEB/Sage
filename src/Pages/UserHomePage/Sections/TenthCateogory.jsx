...
const TenthCategory = () => {
  ...
  useEffect(() => {
    fetchBooksByCategory("Sci-fi", setData, setError, setLoading);
  }, []);
  ...
  return (
    <section className={`${styles.paddingY}`}>
      <h1 className='text-black font-black md:text-[60px] sm:text-[50px] xs:text-[40px] text-[30px]'>Sci-fi</h1>
